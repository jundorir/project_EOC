...
function Modal(props) {
  const {visible, setVisible, languageStore} = props
  if(!visible) {
    return null
  }
  return (
    <div className={css.modal}>
        <div className={css.modalMain}>
          ...
          <div className={css.modalMainContent}>
            <p className={css.modalTit1}>{languageStore.language.battle_defeat}</p>
            <p className={css.modalTit2}>{languageStore.language.battle_defeat_hint1}</p>
            <ul>
                <li>
                  <img src={icon_pub} />
                  <div>
