...
const MarketSelector = ({
  ...
  const LevelList = [
    {
      label: language.Props,
      value: "Props",
    },
    {
      label: language.Heroes,
      value: "ALL",
    },
    {
      label: "UR",
  ...
  return (
    <div className={css.MarketSelector} id="MarketSelector">
      <Selector
        options={LevelList}
        value={[rare]}
        onChange={(v) => {
      ...
      {hasOrder && (
        <Popover.Menu
          ...
          getContainer={() => document.getElementById("MarketSelector")}
...
export default inject("languageStore")(observer(MarketSelector));
